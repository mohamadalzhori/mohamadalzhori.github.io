var Typer = {
    text: '<span id="a">zhori@eniac</span>:<span id="b">~</span><span id="c">$</span> cd vault/me\n' +
          ...
          'I am a student at the Lebanese American University, pursuing a Bachelor of Engineering in <span id="a">Electrical</span> Engineering, with an expected graduation date of <span id="a">May 2025</span>.\n\n'+
          
          'My passion for electrical engineering <span id="a">sparked</span> my journey, and I have honed my skills in programming and software development. \n\n' +
          
          'I am driven by the desire to <span id="a">consistently</span> improve and have a meaningful impact in the world.\n\n' + 
          
          'I am also proud to be a recipient of the prestigious <span id="a">USAID</span> Higher Education Scholarship Program (HES) at the Lebanese American University, which has provided me with invaluable educational opportunities.\n\n' + 
          
          'I am eagerly seeking <span id="a">software</span> engineering opportunities that will allow me to boost and apply my knowledge and skills to solve real-world problems.\n\n' + 
